...
//added by zky--auto detect power outage, set X_MIN_PIN to DETECT_POWER_PIN
#ifdef AUTO_DETECT_POWER_OUTAGE
 #define DETECT_POWER_PIN 43
#else
 #define DETECT_POWER_PIN -1	
#endif 
